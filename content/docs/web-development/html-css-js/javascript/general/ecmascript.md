---
title: "ECMAScript"
description: "ECMAScript, abreviado como ES, es el estándar en el que se basa JavaScript y otros lenguajes de scripting similares (como JScript de Microsoft o ActionScript de..."
---
...
- ECMAScript ha tenido varias versiones importantes, y cada una de ellas ha introducido características que el lenguaje JavaScript. Algunas de ellas son:
...
- **ES6 (2015)**: También conocida como ES2015, fue una gran actualización con características como arrow functions (=>), let/const, clases, promesas, template literals (`${}`), y destructuración. Esta versión cambió el juego en el desarrollo de JavaScript.
