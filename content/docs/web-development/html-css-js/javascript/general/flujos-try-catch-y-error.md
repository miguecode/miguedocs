...
- El bloque try-catch nos permite manejar errores sin que nuestro programa se rompa. Es muy útil para prevenir caídas inesperadas o para manejar errores de forma controlada. s
...
>> Throw en una función y explicación de Error
...
- Sobre el tema de "Error", va a haber un apunte sobre eso, para ver cómo crear nuestros propios errores, y hasta tenerlos en un archivo aparte. Pero en este apunte, vamos a verlo más por encima:
...
- Esto sirve por si tenemos funciones que lanzan errores y queremos preservar el original.