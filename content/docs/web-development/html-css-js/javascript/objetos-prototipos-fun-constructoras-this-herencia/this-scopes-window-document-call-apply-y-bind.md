...
Esto es así ya que estamos invocando a la función mediante la función "ejecutora". Y "ejecutora", es una función declarada en window. Y no dentro del objeto persona. Por esto, va a mostrar datos undefined. Recordemos que el término "callback" refiere a una función que es pasada por parámetro a otra función para ser ejecutada.
