---
title: "Qué es Sass"
description: "A diferencia de frameworks de CSS como Bootstrap o Tailwind, Sass (Syntactically Awesome Stylesheets) es un preprocesador de CSS. Esto significa que extiende la..."
---
