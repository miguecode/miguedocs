...
En este caso, hacemos lo mismo que antes, pero "casi dinámicamente", ya que los valores de las variables "url" y "alt" podrían variar. (Nota: Se usan backticks para los template literals).
...
De esta forma, hicimos exactamente lo mismo que antes, pero no es la forma más común hoy en día. Lo más común es lo anterior, accediendo directamente a textContent: `$subTitulo.textContent = "Hola";`.