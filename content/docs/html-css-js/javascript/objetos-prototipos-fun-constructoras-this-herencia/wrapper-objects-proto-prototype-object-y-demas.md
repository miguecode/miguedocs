...
**Por el lado de los datos primitivos, son**: Number, String, Boolean, Symbol y BigInt.
...
&nbsp;&nbsp;&nbsp;&nbsp; ↑
`[1,2,3]` (Instancia de Array, tiene una propiedad `__proto__` que apunta a `Array.prototype`)
...
Como vemos, el método `Object.getPrototypeOf(objeto)`, retorna el `__proto__` del objeto. Es exactamente lo mismo. Pero a partir de ES6, se empezó a recomendar usar el método en vez de sólo hacer `.__proto__`, porque es más seguro.
