...
Primero, descargamos una máquina virtual llamada VirtualBox, la cual se usa para emular distintos sistemas operativos. Entramos a una página donde podemos descargar archivos que funcionan en VirtualBox para emular cualquier SO que queramos.
Es útil que descarguemos varias de ellas y las tengamos disponibles para usar cuando necesitemos.

🌐 Descargar VirtualBox desde su sitio oficial.
📂 Almacenar diferentes imágenes de sistemas operativos para pruebas y aprendizaje.