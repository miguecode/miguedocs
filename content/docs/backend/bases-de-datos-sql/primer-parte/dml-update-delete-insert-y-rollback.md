...
**¿La recomendación?** Primero hacer el UPDATE o el DELETE o lo que sea, y cuando estoy seguro de que está bien, en ese momento hago el COMMIT. 

```text
UPDATE -> COMMIT -> DELETE -> COMMIT
```

Así todo el tiempo. Si me doy cuenta que me equivoqué, en vez de hacer COMMIT hago ROLLBACK. Y listo, yo tengo que intentar que cuando haga ROLLBACK no vuelva 10 pasos atrás, si no que uno sólo.